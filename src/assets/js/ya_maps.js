...
if ($('.yamap').length) {
    ...
    let map_container = $('.yamap');
    let coordinates = map_container.data('coordinates');
    ...
    async function main() {
      await ymaps3.ready;
        ...
        const map = new YMap(document.getElementById('yamap'), {
            location: {
                center: coordinates,
                zoom: 16
            }
        ...
        markerElement.src = '/assets/img/icons/ic_map_location.svg';
